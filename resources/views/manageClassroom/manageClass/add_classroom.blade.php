...
@section('content')
    ...
    <div class="container fade-in-text">
        <div>
            ...
            <form action="{{ route('add_classroom.create') }}" method="post">
                ...
                <div class="mb-5">
                    ...
                    <div class="row mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-end fw-bold">{{ __('Classroom Name') }} <label class="red-aestrist">*</label></label>
        ...
        <div>
            <header>
                <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                    {{ __('Upload List Of Classrooms') }}
                </h4>
            </header>
            <form action="{{ route('import.classroom') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                @csrf
                ...
                <button type="submit" class="btn btn-success tr-button w-full mt-2 py-2">Import Classrooms</button>
            </form>
        </div>
    </div>
@endsection