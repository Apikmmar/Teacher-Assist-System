...
@section('content')
    <div class="container fade-in-text">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
            <div>
                <h2 class="mb-1"><i class="bi bi-clipboard-data me-2"></i>Examination Marks</h2>
        ...
        <form action="{{ route('update_exam_mark.update') }}" method="post">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <div class="input-group" style="max-width: 100px;">
                                                <input type="text" class="form-control text-center mark-input" name="student_marks[]" 
                                                        value="{{ $studentGrades[$student->id]->marks ?? '' }}" placeholder="Mark" aria-label="Mark input">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <div class="input-group" style="max-width: 100px;">
                                                <input type="text" class="form-control text-center grade-output" name="student_grades[]" 
                                                        value="{{ $studentGrades[$student->id]->grade ?? '' }}" placeholder="Grade" aria-label="Grade input" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <div class="input-group" style="max-width: 200px;">
                                                <input type="text" class="form-control text-center" name="student_feedbacks[]" 
                                                        value="{{ $studentGrades[$student->id]->feedback ?? '' }}" placeholder="Feedback" aria-label="Feedback input">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                <button type="submit" class="btn btn-primary px-4 py-2 shadow-sm">
                    <i class="bi bi-check-circle me-1"></i>Update Marks
                </button>
