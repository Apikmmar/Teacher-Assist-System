...
@section('content')
    ...
    <div class="container fade-in-text">
        ...
        <div>
            ...
            <form action="{{ route('import.teacher') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                @csrf
                ...
                <button type="submit" class="btn btn-success tr-button w-full mt-2 py-2">Import Teacher</button>
            </form>
        </div>
    </div>
@endsection