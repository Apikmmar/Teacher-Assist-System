...
class Role_UsersSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('role__users')->insert([
            ...
            ['user_id' => 6, 'role_id' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 6, 'role_id' => 2, 'created_at' => $now, 'updated_at' => $now],

            ['user_id' => 7, 'role_id' => 2, 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 7, 'role_id' => 3, 'created_at' => $now, 'updated_at' => $now],

            ['user_id' => 8, 'role_id' => 2, 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 8, 'role_id' => 3, 'created_at' => $now, 'updated_at' => $now],

            ['user_id' => 9, 'role_id' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 9, 'role_id' => 3, 'created_at' => $now, 'updated_at' => $now],

            ['user_id' => 10, 'role_id' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 10, 'role_id' => 3, 'created_at' => $now, 'updated_at' => $now],
        ]);
    }
}
